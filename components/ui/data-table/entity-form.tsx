    ...
    >
      <DialogContent className={`w-full max-h-[90vh] flex flex-col`}>
        ...
        <Form {...form}>
          ...
          >
            <div className="flex-1 overflow-y-auto pr-1 py-4 max-h-[60vh] grid md:grid-cols-2 gap-4">
              {children}
            </div>

            <DialogFooter className="mt-4 pt-4 border-t sticky top-0 bg-background">
              <DialogClose asChild>
                <Button
                  type="button"
                  variant="outline"
